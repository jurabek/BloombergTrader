    ...
    public class Datetime
    {
        ...
        public Datetime(DateTime datetime)
        {
            ...
            switch (datetime.Kind)
            {
                ...
                case DateTimeKind.Local:
                    this.TimezoneOffsetMinutes = TimeZoneInfo.Local.GetUtcOffset(datetime).Hours * 60;
                    return;
                default:
                    return;
            }
        ...
        public DateTime ToSystemDateTime()
        {
            ...
            if (this.HasParts(TIME_ZONE_OFFSET))
            {
                ...
                {
                    if ((double)this.TimezoneOffsetMinutes == TimeZoneInfo.Local.GetUtcOffset(DateTime.Now).TotalMinutes)
                    {
